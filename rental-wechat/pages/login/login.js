  ...
  getLogin: function () {
    ...
    wx.login({
      success: function (res) {
        ...
        wx.request({
          // url: 'https://api.weixin.qq.com/sns/jscode2session?appid=wxd213baa10a187e9c&secret=48913edcb1b58f214765eb5581ecacf1&js_code=' + that.data.code + '&grant_type=authorization_code',//测试版请求
          url: 'https://changjienongye.cn/docs/getOpenIdzf.jsp?code=' + that.data.code,
          method: 'POST',
          header: {
            'content-type': 'application/json'
          },
